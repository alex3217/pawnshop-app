...
const routes: Array<{ name: string; path: string; role?: Role }> = [
  ...
  { name: "Buyer Sell or Pawn", path: "/buyer/sell-item", role: "CONSUMER" },
  { name: "Consumer Marketplace Listing", path: "/marketplace/listings/new", role: "CONSUMER" },
  ...
  { name: "Owner Create Item", path: "/owner/items/new", role: "OWNER" },
