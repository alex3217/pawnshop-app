...
const webkitGateSpecs = /(?:release-candidate-accessibility|auth-401-regression|route-protection|customer-scan-marketplace-listing|scanner-marketplace-listing-entry|marketplace-buy-now|marketplace-checkout|marketplace-fulfillment|marketplace-receipts-fulfillment|owner-onboarding-regression|homepage-layout|item-locator-empty-results|public-listing-image-visibility|buyer-navigation-parity|seller-shop-readability|super-admin-navigation-a11y|owner-application-review)\.spec\.ts/;
