...
export const BUYER_NAVIGATION = [
  ...
  { to: "/buyer/messaging-profile", label: "Profile & messaging settings" },
  { to: "/watchlist", label: "Watchlist" },
  { to: "/saved-searches", label: "Saved Searches" },
  { to: "/marketplace/listings/mine", label: "My Listings" },
  { to: "/marketplace/listings/received", label: "Listings Sent to Me" },
...
export const BUYER_PATHS = {
  ...
  offers: "/offers",
  messagingProfile: "/buyer/messaging-profile",
  watchlist: "/watchlist",
  savedSearches: "/saved-searches",
  listings: "/marketplace/listings/mine",
  receivedListings: "/marketplace/listings/received",
