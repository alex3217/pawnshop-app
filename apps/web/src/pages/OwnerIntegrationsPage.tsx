...
function statusStyle(status: IntegrationStatus | string): CSSProperties {
  const base: CSSProperties = {
    ...
    fontSize: 12,
    fontWeight: 900,
    border: "1px solid var(--owner-int-border)",
  };
  ...
  if (["READY", "CONNECTED"].includes(String(status))) {
    return {
      ...
      color: "var(--owner-int-success-badge-text)",
  ...
  if (String(status) === "NEEDS_SETUP") {
    return {
      ...
      color: "var(--owner-int-warning-badge-text)",
  ...
  if (String(status) === "ERROR") {
    return {
      ...base,
      background: "var(--owner-int-danger-bg)",
      color: "var(--owner-int-danger-text)",
  ...
  return {
    ...
    color: "var(--owner-int-neutral-badge-text)",
...
const styles: Record<string, CSSProperties> = {
  page: {
    display: "grid",
    gap: 20,
    background: "var(--owner-int-page-bg)",
    color: "var(--owner-int-text)",
  },
  hero: {
    display: "flex",
  ...
  primaryLink: {
    ...
    textDecoration: "none",
    border: "1px solid var(--owner-int-border)",
    background: "var(--owner-int-primary-bg)",
    color: "var(--owner-int-primary-text)",
    borderRadius: 12,
    padding: "10px 14px",
    fontWeight: 900,
  },
  secondaryLink: {
    ...
    textDecoration: "none",
    border: "1px solid var(--owner-int-border)",
    background: "var(--owner-int-button-bg)",
    color: "var(--owner-int-button-text)",
    borderRadius: 12,
    padding: "10px 14px",
    fontWeight: 800,
  },
  ...
  statCard: {
    border: "1px solid var(--owner-int-soft-border)",
    background: "var(--owner-int-panel-bg)",
    borderRadius: 18,
    padding: 18,
  },
  statLabel: {
  ...
  input: {
    border: "1px solid var(--owner-int-border)",
    background: "var(--owner-int-input-bg)",
    color: "var(--owner-int-button-text)",
    borderRadius: 12,
    padding: "11px 12px",
    width: "100%",
  ...
  dangerButton: {
    border: "1px solid var(--owner-int-danger-border)",
    background: "var(--owner-int-danger-bg)",
    color: "var(--owner-int-danger-text)",
    borderRadius: 12,
    padding: "9px 12px",
  ...
  loadingCard: {
    border: "1px solid var(--owner-int-soft-border)",
    background: "var(--owner-int-card-bg)",
    borderRadius: 14,
    padding: 16,
  },
  connectorGrid: {
  ...
  jobList: {
    borderTop: "1px solid var(--owner-int-soft-border)",
    paddingTop: 12,
    display: "grid",
    gap: 8,
  },
