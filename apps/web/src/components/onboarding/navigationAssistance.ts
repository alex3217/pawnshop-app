...
export const ROUTE_ASSISTANCE: RouteAssistance[] = [
  ...
  route("item-edit", "Edit Item", "Correct a specific inventory record.", [/^\/owner\/items\/[^/]+\/edit\/?$/], ["Verify you are editing the intended physical item and location.", "Update condition, pricing, identifiers, photos, or availability.", "Save and confirm dependent marketplace listings remain accurate."]),
