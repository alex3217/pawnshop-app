...
export type BuyerPlanUsage = {
  ...
  entitlements: { savedSearchLimit: number | null; maxActiveShopRequests: number | null; maxMonthlyShopRequests: number | null; maxActiveMarketplaceListings: number | null; maxMonthlyMarketplaceListings: number | null; maxSellItemPhotos: number | null; maxSellRadiusMiles: number | null; maxAiListingGenerationsPerMonth: number; wishListLimit: number | null; favoriteLimit: number | null; comparisonLimit: number | null; alertLevel: string; notificationPriority: string; workspaceLevel: string; workspaceCustomizationEnabled: boolean; collectionManagerEnabled: boolean; collectionItemLimit: number | null; marketIntelligenceLevel: string; conciergeEnabled: boolean; supportLevel: string };
  usage: { savedSearches: BuyerLimitUsage; watchlistItems: BuyerLimitUsage; activeShopRequests: BuyerLimitUsage; monthlyShopRequests: BuyerLimitUsage; activeMarketplaceListings: BuyerLimitUsage; monthlyMarketplaceListings: BuyerLimitUsage; aiListingGenerations: BuyerLimitUsage; wishLists: BuyerLimitUsage; comparisons: BuyerLimitUsage; collectionItems: BuyerLimitUsage; aiRequests: BuyerLimitUsage; activeAlerts: number; referralRewards: number; loyaltyPoints: number };
  implementation: Record<string, boolean>;
  coreCommerce: Record<string, boolean>;
};
export type BuyerPlanCatalogEntry = { code: "FREE" | "PLUS" | "PREMIUM" | "ULTRA"; label: string; monthlyPriceCents: number; yearlyPriceCents: number; currency: string; annualSavingsCents: number; isPaid: boolean; isFree: boolean; rank: number; stripeMonthlyPriceId: string | null; stripeYearlyPriceId: string | null; maxSavedSearches: number | null; maxWatchlistItems: number | null; maxActiveShopRequests: number | null; maxMonthlyShopRequests: number | null; maxActiveMarketplaceListings: number | null; maxMonthlyMarketplaceListings: number | null; maxSellItemPhotos: number | null; maxSellRadiusMiles: number | null; maxAiListingGenerationsPerMonth: number; features: string[] };
