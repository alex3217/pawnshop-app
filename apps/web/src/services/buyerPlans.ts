...
export type BuyerPlanCatalogEntry = { code: "FREE" | "PLUS" | "PREMIUM" | "ULTRA"; label: string; monthlyPriceCents: number; yearlyPriceCents: number; currency: string; annualSavingsCents: number; isPaid: boolean; isFree: boolean; rank: number; monthlyCheckoutConfigured: boolean; yearlyCheckoutConfigured: boolean; maxSavedSearches: number | null; maxWatchlistItems: number | null; features: string[] };
