...
function createSellerPlan(config) {
  ...
  return Object.freeze({
    ...
    maxItemPhotos: toNonNegativeIntegerOrNull(config.maxItemPhotos, `${code}.maxItemPhotos`),
    maxAiListingGenerationsPerMonth: toNonNegativeIntegerOrNull(config.maxAiListingGenerationsPerMonth, `${code}.maxAiListingGenerationsPerMonth`),
...
export const SELLER_PLANS = Object.freeze({
  ...
  [SELLER_PLAN_CODES.ULTRA]: createSellerPlan({
    ...
    commissionBps: 400,
    features: [
      "Unlimited active listings subject to fair use and platform integrity controls",
      "Unlimited locations",
