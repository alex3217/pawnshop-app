...
import { addWatchlistItemWithinCapacity } from "../services/buyerEntitlements.service.js";
...
export async function addToWatchlist(req, res) {
  try {
    ...
    const entry = await addWatchlistItemWithinCapacity({
      userId,
      itemId,
      include: WATCHLIST_ENTRY_INCLUDE,
    });
