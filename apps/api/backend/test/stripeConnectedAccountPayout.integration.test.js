...
before(async () => {
  Object.assign(process.env, {
    NODE_ENV: "test",
    APP_ENV: "test",
    JWT_SECRET: ["integration", "-", "test", "-", "only", "-", "secret", "-", "x".repeat(32)].join(""),    STRIPE_SECRET_KEY: ["sk", "_", "test", "_", "integration", "_", "fixture"].join(""),    STRIPE_CONNECT_WEBHOOK_SECRET: WEBHOOK_SECRET,
