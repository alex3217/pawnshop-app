...
const required = [
  ...
  "STRIPE_PRICE_BUYER_PLUS", "STRIPE_PRICE_BUYER_PREMIUM",
  "STRIPE_PRICE_BUYER_ULTRA", "AUCTION_SCHEDULER_ENABLED",
...
boolean("CORS_ALLOW_PAWNLOOP_PREVIEWS", "true");
boolean("SMTP_SECURE");
...
const formats = {
  ...
  STRIPE_PRICE_BUYER_PLUS: /^price_[A-Za-z0-9_]+$/,
  STRIPE_PRICE_BUYER_PREMIUM: /^price_[A-Za-z0-9_]+$/,
  STRIPE_PRICE_BUYER_ULTRA: /^price_[A-Za-z0-9_]+$/,
};
