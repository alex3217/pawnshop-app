...
const outDir = "reports/owner-integrations-control-audit";
...
async function inspectTheme(theme, token) {
  ...
  await page.goto(`${WEB}/owner/integrations?fresh=${Date.now()}`, {
  ...
  await page.screenshot({
    path: path.join(outDir, `owner-integrations-${theme}.png`),
    fullPage: true,
  });
